...
const CreateSessionScreen = ({location, history}) => {
    ...
    const sessionRegister = useSelector(state => state.sessionRegister)
    const {loading, error, userInfo} = sessionRegister
    ...
    return (
        <section className='register_section'>
            <form className='form' onSubmit={submitHandler}>
                <h1 className='text-center'>créer une session</h1>
